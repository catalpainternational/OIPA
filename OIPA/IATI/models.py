...
class transaction(models.Model):
    ...
    provider_organisation_name = models.CharField(max_length=150, null=True, default=None)
    ...
    receiver_organisation_name = models.CharField(max_length=150, null=True, default=None)
