...
class activity(models.Model):
    ...
    hierarchy = models.SmallIntegerField(choices=hierarchy_choices, default=1, null=True, blank=True)
    ...
    reporting_organisation = models.ForeignKey(organisation, null=True, blank=True, default=None, related_name="activity_reporting_organisation")
    activity_status = models.ForeignKey(activity_status, null=True, blank=True, default=None)
    ...
    participating_organisation = models.ManyToManyField(organisation, through="activity_participating_organisation", null=True, blank=True)
    policy_marker = models.ManyToManyField(policy_marker, through="activity_policy_marker", null=True, blank=True)
    sector = models.ManyToManyField(sector, through="activity_sector", null=True, blank=True)
    ...
    collaboration_type = models.ForeignKey(collaboration_type, null=True, blank=True, default=None)
    default_flow_type = models.ForeignKey(flow_type, null=True, blank=True, default=None)
    default_aid_type = models.ForeignKey(aid_type, null=True, blank=True, default=None)
    default_finance_type = models.ForeignKey(finance_type, null=True, blank=True, default=None)
    default_tied_status = models.ForeignKey(tied_status, null=True, blank=True, default=None)
    xml_source_ref = models.CharField(null=True, blank=True, max_length=200)
    total_budget_currency = models.ForeignKey(currency, null=True, blank=True, default=None, related_name="total_budget_currency")
    total_budget = models.DecimalField(max_digits=15, decimal_places=2, null=True, blank=True, default=None, db_index=True)
...
class contact_info(models.Model):
    activity = models.ForeignKey(activity)
    person_name = models.CharField(max_length=100, null=True, blank=True, default=None)
    organisation = models.CharField(max_length=100, null=True, blank=True, default=None)
    ...
    mailing_address = models.TextField(null=True, blank=True, default=None)
...
class transaction(models.Model):
    activity = models.ForeignKey(activity)
    aid_type = models.ForeignKey(aid_type, null=True, blank=True, default=None)
    description = models.TextField(null=True, blank=True, default=None)
    description_type = models.ForeignKey(description_type, null=True, blank=True, default=None)
    disbursement_channel = models.ForeignKey(disbursement_channel, null=True, blank=True, default=None)
    finance_type = models.ForeignKey(finance_type, null=True, blank=True, default=None)
    flow_type = models.ForeignKey(flow_type, null=True, blank=True, default=None)
    provider_organisation = models.ForeignKey(organisation, related_name="transaction_providing_organisation", null=True, blank=True, default=None)
    provider_organisation_name = models.CharField(max_length=200, null=True, blank=True, default=None)
    provider_activity = models.CharField(max_length=100, null=True, blank=True,)
    receiver_organisation = models.ForeignKey(organisation, related_name="transaction_receiving_organisation", null=True, blank=True, default=None)
    receiver_organisation_name = models.CharField(max_length=200, null=True, blank=True, default=None)
    tied_status = models.ForeignKey(tied_status, null=True, blank=True, default=None)
    transaction_date = models.DateField(null=True, blank=True, default=None)
    transaction_type = models.ForeignKey(transaction_type, null=True, blank=True, default=None)
    ...
    ref = models.CharField(max_length=100, null=True, blank=True, default=None)
