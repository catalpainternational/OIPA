...
class transaction(models.Model):
    ...
    provider_organisation_name = models.CharField(max_length=200, null=True, default=None)
    ...
    receiver_organisation_name = models.CharField(max_length=200, null=True, default=None)
